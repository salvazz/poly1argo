...
# Import from Argo_Motor_24x7.py
...
def ejecutar_mision_compra():
    ...
    try:
        ...
        if data["accion"] == "COMPRAR" and analisis["edge"] > 0.03:
            ...
            actualizar_aprendizaje(modelo_usado, True)
            return {"status": "Compra ejecutada", "data": data}
        else:
            return {"status": "No action", "reason": "Condition not met"}
    except Exception as e:
